...
var Locations = /** @class */ (function () {
  ...
  Locations.prototype.display = function () {
    content.innerHTML +=
      "<div class='card col-md-3 d-flex flex-column my-3 p-1'>\n  \n    <img src='" +
      this.image +
      "' class='card-img-top d-none d-md-block' alt=''>\n    \n    <div class='card-body px-2 pt-0'>    \n    <div><div class='card-text1'>" +
      this.object +
      ...
      "<br>" +
      this.address +
      '</div></div>\n        \n    <div class="visited"><br><i>created:<br>' +
      this.visited +
      "</i></div></div>\n    \n    </div>";
  };
  return Locations;
...
var Restaurants = /** @class */ (function (_super) {
  ...
  function Restaurants(
    ...
    var _this =
      _super.call(this, object, city, zipCode, address, image, visited) || this;
    _this.phone = phone;
